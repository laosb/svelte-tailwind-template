...
This is a project template for [Svelte](https://svelte.dev) apps with [Tailwind CSS](https://tailwindcss.com/) support. It lives at https://github.com/laosb/svelte-tailwind-template. Forked from official Svelte app template.
